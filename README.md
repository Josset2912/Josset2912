...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=js,html,css,vite,tailwind,sqlite,react,py,powershell,pnpm,ps,npm,notion,nodejs,nextjs,mongo.db,md,linkedin,jquery,instagram,gmail,git,github,flask,django,discord,cs,cpp,bun,bootstrap,bash,astro,raspberrypi)]
# 📊 GitHub Stats:
